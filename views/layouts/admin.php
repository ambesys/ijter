...
<head>
    ...
    <title><?= $pageTitle ?? 'Admin Dashboard | Research Journal' ?></title>
    ...
    <!-- Custom styles -->
    <link href="<?= config('app.url') ?>assets/css/admin.css" rel="stylesheet">
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="<?= config('app.url') ?>admin/papers" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" name="search" placeholder="Search for papers..." aria-label="Search">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                                <form class="form-inline mr-auto w-100 navbar-search" action="<?= config('app.url') ?>admin/papers" method="get">
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small" name="search" placeholder="Search for papers..." aria-label="Search">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="submit">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= config('app.url') ?>" target="_blank">
    ...
    <script src="<?= config('app.url') ?>assets/vendor/sb-admin-2/js/sb-admin-2.min.js"></script>
    
    <!-- Page level plugins -->
    <script src="<?= config('app.url') ?>assets/vendor/chart.js/Chart.min.js"></script>
    <script src="<?= config('app.url') ?>assets/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="<?= config('app.url') ?>assets/vendor/datatables/dataTables.bootstrap4.min.js"></script>
    
    <!-- Custom scripts -->
    <script src="<?= config('app.url') ?>assets/js/admin.js"></script>
